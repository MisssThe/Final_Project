...
public class NetWorkManager : MonoBehaviour
{
    ...
    public static void StartToFight(byte[] data)
    {
        ...
        //进入战斗
        LuaManager.Instance.Env.DoString("FightSystem.StartFight('"+my_name+"','"+his_name+"',"+ IsFirst+ ",100,100,100,1,10,3,100,100,100,1,10)");
        //传入参数 对手名字，先手后手
    ...
    public void ReceivePlayerAttribute(byte[] data)
    {
        ...
        else
        {
            ...
            other.name = his_name;
            Debug.Log(his_name + "dsaadswswadasdwda");
